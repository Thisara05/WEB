    ...
    <div id="templatemo_container">
        <div id="templatemo_menu">
            <ul>
                ...
                <li><a href="faq.php" class="current">FAQ/Help</a></li>
            ...
            <div id="templatemo_content_right">
                <div class="faq">
                    <div class="faq-q">
                        ...
                        <p>
                            Yes you can, provided your order has not been shipped. Mail us
                            at care@farminii.com to change your order information. Please
                            note that after your order is shipped you cannot change any
                    ...
                    <div class="faq-q">
                        ...
                        <p>
                            Mail us at care@farminii.com to change your order information.
                            Please note that after your order is shipped you cannot change
                            any details on your order.
                        </p>
                    </div>
                    <div class="faq-q">
                        <span>
                        ...
                        <p>
                            Mail us at ;care@farminii.com&amp; to change your order
                            information. Please note that after your order is shipped you
                            cannot change any details on your order.
                        </p>
                    </div>
                    <div class="faq-q">
                        <span>
                        ...
                        <p>
                            You can email us a care@farminii. and your order will be placed
                            as per your choice. Please mention preferable colors, sizes,
        ...
        <div id="templatemo_footer" style="margin-left: -10px;">
            ...
            <a href="contact.php">Contact</a> | <a href="faq.php">FAQ/Help</a>
            <br />
            <p>© Copyright 2018 Tharusha | All Rights Reserved.</p>
            <a href="#"><strong>WONDERBOOKS</strong></a>
        </div>
    </div>
</body>
