...
<fieldset class="body">
	<div class="pcard">
		<div class="left"></div>
		<div class="proimg"><img src="img/Ryzen5.png" width="400px" height="400px"></div>
		<div class="protext">
			<h1>AMD RYZEN 5 3500X</h1>
			<h2>49,000 LKR</h2>
			<table>
				<tr>
	...
	<table>
				...
				<tr>
					...
					<td class="sptb2">3.6GHz</td>
				</tr>
				<tr>
					<td class="sptb1">Max Boost Clock</td>
					<td class="sptb2">Up to 4.1GHz</td>
				</tr>
				<tr>
					<td class="sptb1">Total L1 Cache</td>
					<td class="sptb2">384KB</td>
				</tr>
				<tr>
					<td class="sptb1">Total L2 Cache</td>
					<td class="sptb2">3MB</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="sptb2">Stealth Wraith</td>
				</tr>
				<tr>
					<td class="sptb1">Default TDP</td>
					<td class="sptb2">65W</td>
				</tr>
				<tr>
