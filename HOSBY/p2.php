...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/pamd.css">
...
<fieldset class="body">
	<div class="pcard">
		<div class="left"></div>
		<div class="proimg"><img src="img/Ryzen7.png" width="400px" height="400px"></div>
		<div class="protext">
	...
	<table>
				...
				<tr>
					...
					<td class="sptb2">16</td>
				</tr>
				<tr>
					<td class="sptb1">Base Clock</td>
					<td class="sptb2">3.9GHz</td>
				</tr>
				<tr>
					<td class="sptb1">Max Boost Clock</td>
					<td class="sptb2">Up to 4.5GHz</td>
				</tr>
				<tr>
					<td class="sptb1">Total L1 Cache</td>
					<td class="sptb2">64KB</td>
				</tr>
				<tr>
					<td class="sptb1">Total L2 Cache</td>
					<td class="sptb2">4MB</td>
				</tr>
				<tr>
					<td class="sptb1">Total L3 Cache</td>
					<td class="sptb2">32MB</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="sptb1">CMOS</td>
					<td class="sptb2">TSMC 7nm FinFET</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="sptb1">PCI Express Version</td>
					<td class="sptb2">PCIe 4.0 x16</td>
				</tr>
				<tr>
					<td class="sptb1">Thermal Solution</td>
					<td class="sptb2">Wraith Prism with RGB LED</td>
				</tr>
				<tr>
					<td class="sptb1">Default TDP / TDP</td>
					<td class="sptb2">105W</td>
				</tr>
				<tr>
