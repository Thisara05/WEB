...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/pintel.css">
...
<fieldset class="body">
	<div class="pcard">
		<div class="left"></div>
		<div class="proimg"><img src="img/INTELi9.png" width="400px" height="400px"></div>
		<div class="protext">
			<h1>INTEL CORE I9-10900K</h1>
			<h2>120,000 LKR</h2>
			<table>
				<tr>
					<td width="200px">CPU Cores</td>
					<td>10</td>
				</tr>
				<tr>
					<td>CPU Threads</td>
			...
			<a href="#" class="card_link">Add To Cart</a>
		</div>
	</div>
	...
	<table>
				<tr>
					<td width="400px" class="sptb1">Number of CPU Cores</td>
					<td class="sptb2">10</td>
				</tr>
				<tr>
					<td class="sptb1">Number of Threads</td>
					<td class="sptb2">20</td>
				</tr>
				<tr>
					<td class="sptb1">Base Clock</td>
					<td class="sptb2">3.70GHz</td>
				</tr>
				<tr>
					<td class="sptb1">Max Boost Clock</td>
					<td class="sptb2">5.30GHz</td>
				</tr>
				<tr>
					<td class="sptb1">Cache</td>
					<td class="sptb2">20 MB Intel® Smart Cache</td>
				</tr>
				<tr>
					<td class="sptb1">Processor Graphics</td>
					<td class="sptb2">Intel® UHD Graphics 630</td>
				</tr>
				<tr>
					<td class="sptb1">DirectX* Support</td>
					<td class="sptb2">12</td>
				</tr>
				<tr>
					<td class="sptb1">Unlocked</td>
					<td class="sptb2">Yes</td>
				</tr>
				<tr>
					<td class="sptb1">OpenGL Support</td>
					<td class="sptb2">4.5</td>
				</tr>
				<tr>
					<td class="sptb1">Package</td>
					<td class="sptb2">AM4</td>
				</tr>
				<tr>
					<td class="sptb1">Graphics Video Max Memory</td>
					<td class="sptb2">64 GB</td>
				</tr>
				<tr>
					<td class="sptb1">Thermal Solution</td>
					<td class="sptb2">Cooler Not Included, Liquid Cooling Recommended</td>
				</tr>
				<tr>
					<td class="sptb1">Default TDP</td>
					<td class="sptb2">125W</td>
				</tr>
				<tr>
					<td class="sptb1">System Memory</td>
					<td class="sptb2">3200MHz</td>
				</tr>
				<tr>
					<td class="sptb1">System Memory Type</td>
					<td class="sptb2">DDR4-2933</td>
				</tr>
				<tr>
					<td class="sptb1">Memory Channels</td>
					<td class="sptb2">2</td>
				</tr>
			</table>
			</div>
