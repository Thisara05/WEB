...
<fieldset class="body">
	<div class="pcard">
		<div class="left"></div>
		<div class="proimg"><img src="img/Ryzen3.png" width="400px" height="400px"></div>
		<div class="protext">
	...
	<table>
				...
				<tr>
					...
					<td class="sptb2">PCIe 3.0 x8</td>
				</tr>
				<tr>
					<td class="sptb1">Thermal Solution</td>
					<td class="sptb2">Wraith Stealth</td>
				</tr>
				<tr>
