...
<body style="background-image: url(img/body_back.png);"><br><br>
	...
	<br><br><br>
	<fieldset class="body">
		<div class="logincard"><br><br><br><br><br><br><br>
		<h1 style="color: red;font-size: 30pt;">REGISTRATION SUCSSUS</h1><br><br><br><br>
		<button><a href="login.php" style="text-decoration: none; color: red; font-weight: bold;">LOGIN</button>
			<?php
			$email=$_POST["remail"];
			$pass=$_POST["rpass"];
			$name=$_POST["rname"];
